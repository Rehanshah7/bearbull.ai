...
export default function DashboardClient({ user }: DashboardClientProps) {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-[calc(100vh-100px)] gap-6">
      ...
      {/* LEFT SIDEBAR: Nav, Saved Watchlist & Profit/Loss Movers */}
      ...
      {/* RIGHT MAIN PANEL: Ticker tape, Indices, Welcome, Search, and Analytics */}
      <div className="flex-1 space-y-6 min-w-0">
        ...
        <div className="rounded-2xl overflow-hidden border border-white/10">
          <TickerTape
            ...
            onSelectTicker={(symbol) => setActiveTicker(symbol)}
          />
        </div>
            ...
            {indicesQuotes.map((indexQuote) => {
              ...
              return (
                <div
                  ...
                  onClick={() => setActiveTicker(indexQuote.symbol)}
        ...
        {showWelcome && (
          <div className="rounded-3xl border border-white/10 bg-slate-900/60 p-8 backdrop-blur-xl shadow-2xl relative">
            ...
            <p className="text-slate-400 text-sm max-w-xl">
              <span>
                Currently viewing in-depth analysis for <strong className="text-indigo-400 font-extrabold">{activeTicker ? activeTicker : "Stcok Market"}</strong>.
              </span>
            </p>
          </div>
        )}
        ...
        <div className="space-y-4">
          ...
          <StockSearch onSearch={(symbol) => setActiveTicker(symbol)} />
        </div>
