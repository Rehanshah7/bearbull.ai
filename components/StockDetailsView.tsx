      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        ...
        <div className="text-left md:text-right space-y-1">
          <div className="flex items-baseline gap-3 md:justify-end">
            ...
            <span className={`flex items-center gap-0.5 text-xs md:text-sm font-bold px-2 py-0.5 rounded-lg ${quote.regularMarketChangePercent !== undefined && quote.regularMarketChangePercent >= 0 ? 'bg-emerald-500/10 text-emerald-400' : 'bg-rose-500/10 text-rose-400'}`}>
              {quote.regularMarketChangePercent !== undefined && quote.regularMarketChangePercent >= 0 ? <TrendingUp className="h-3.5 w-3.5" /> : <TrendingDown className="h-3.5 w-3.5" />}
